...
<section id="about" className="text-gray-400 bg-gray-900 body-font">
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-800 sm:flex-row flex-col">
      <div className="flex-grow text-right  mt-6 sm:mt-0">
    ...
    <Link href="/projects">
      <a >
        <button className="flex mx-auto mt-20 text-white bg-blue-600 border-0 py-2 px-8 focus:outline-none hover:bg-blue-500 rounded text-lg items-center gap-2">See my work <BsCodeSlash/> </button>
      </a>
    </Link>
  </div>
</section>
