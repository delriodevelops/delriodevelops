			...
			projects: [
				{
					...
					description: [
						"• Parte del equipo que desarrolla una aplicación interna de préstamos mayoristas para Banco Santander, utilizando DLX (Digital Loan Exchange), una plataforma especializada en la gestión del ciclo de vida completo de préstamos sindicados y corporativos.",
						"• Aunque tengo formación técnica, no trabajo en desarrollo frontend tradicional. DLX proporciona su propia interfaz a través de un SDK, por lo que mi enfoque está en implementar la lógica de negocio y adaptar los flujos a las necesidades del banco.",
						"• Trabajo principalmente con TypeScript, configurando y ampliando el SDK de DLX para:",
						"• Modelar entidades financieras como líneas de crédito, tramos, contratos y participantes.",
						"• Definir validaciones personalizadas, condiciones y lógica de flujo de trabajo adaptadas a Santander.",
						"• Conectar componentes internos y gestionar escenarios complejos de préstamos.",
						"• Automatizar tareas repetitivas y optimizar procesos de negocio.",
						"• También colaboro con personas no técnicas para convertir requisitos legales y operativos en lógica que se integra en el ecosistema DLX.",
						"• Lo que hace que este rol sea único es la exposición al mundo de los préstamos mayoristas: estructuras de sindicación, distribución de participantes, asignación de roles, eventos financieros y trazabilidad contractual, todo desde la perspectiva de un desarrollador.",
					],
					techs: ["TypeScript", "DLX SDK", "Node.js", "Git", "JavaScript"],
				},
			],
		},
		{
			...
			<section className="bg-lime-500 h-[150px] w-fit rounded-2xl flex mx-auto">
				...
				<div className="pl-4 pr-8 py-4 flex flex-col content-evenly">
					...
					<div className="grid grid-cols-3 justify-items-center mt-4">
						<a href="https://iamdelrio.com" className="flex items-center gap-2">
							<IoGlobeOutline /> iamdelrio.com
						</a>
						<a href="https://www.linkedin.com/in/iamdelrio" className="flex items-center gap-2">
							<IoLogoLinkedin /> iamdelrio
						</a>
						<a href="https://github.com/delriodevelops" className="flex items-center gap-2">
							<IoLogoGithub /> delriodevelops
						</a>
					</div>
				</div>
			</section>
			<div className="grid grid-cols-4 my-8 gap-2">
				<div className="col-span-1 flex flex-col gap-12">
					...
					<section>
						...
						<ul className="mt-2 ml-2 uppercase">
                            <li>
								<a href="https://fainancial.app">fainancial</a>
							</li>
							<li>
								<a href="https://meshmind.vercel.app">meshmind</a>
							</li>
							<li>
								<a href="https://escudolealjpt.com">escudo leal jpt</a>
							</li>
							<li>
								<a href="https://baitme.iamdelrio.com/">baitme</a>
							</li>
						</ul>
					</section>
				</div>
				<div className="col-span-3 grid max-w-[650px]">
					<section className="w-full">
						...
						<p className="mt-2 text-pretty w-full ml-4">
							Experiencia en proyectos profesionales y personales, enfocado en{" "}
							<b className="bg-yellow-200 px-1 rounded">tecnologías emergentes</b> y{" "}
							<b className="bg-yellow-200 px-1 rounded">desarrollo web moderno</b>.<br />
							Busco oportunidades para <b className="bg-yellow-200 px-1 rounded">crecer</b> y{" "}
							<b className="bg-yellow-200 px-1 rounded">aprender</b> en los campos de{" "}
							<b className="bg-yellow-200 px-1 rounded">programación</b> y{" "}
							<b className="bg-yellow-200 px-1 rounded">IA</b>.
						</p>
					</section>
								...
								<div key={i} className="mb-10">
									<div className="flex">
										<img
											src={company.img}
											alt=""
											className="w-[50px] h-[50px] rounded-full border-2 border-neutral-700"
										/>
										<div className="pl-4">
											<h4 className="text-lg font-bold">{company.company}</h4>
											<h5 className="text-md text-neutral-700">
												{company.contract} -{" "}
												{calculateTimeDifference(
													company.projects.at(-1).dateStart,
													company.projects[0].dateEnd || undefined,
												)}{" "}
												- {company.remote}
											</h5>
										</div>
										...
										{company.projects.map((project, i) => (
											<li key={i} className="relative border-l-2 border-neutral-700 pl-6">
												...
												<p className="text-neutral-700">
													{project.dateStart} - {project.dateEnd || "Actualidad"}{" "}
													·{" "}
													{calculateTimeDifference(
														project.dateStart,
												...
												<p
													className={`${
														i !== company.projects.length - 1 && "pb-12"
													} pt-6 grid`}>
													<span className="bg-lime-300 rounded-full p-2 w-fit font-bold text-sm uppercase">
														Tecnologías
													</span>
