        ...
        <section id="contact" className="contact section">
          <div className="container">
            <div className="contact-grid">
              <div className="contact-info" style={{ opacity: 0, transform: 'translateX(-60px)' }}>
                <span className="section-label">Get in touch</span>
                <h2 className="contact-title">
                  Let&apos;s build<br />
                  <span style={{ color: 'var(--color-accent)' }}>something great.</span>
                </h2>
                ...
                <div className="contact-links">
                  <a href="mailto:hello@iamdelrio.com" className="contact-link">
                    <Mail size={20} />
                    hello@iamdelrio.com
                  </a>
                </div>
                ...
                <div className="social-links">
                  <a href="https://www.linkedin.com/in/iamdelrio" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="LinkedIn">
                    <Linkedin size={20} />
                  </a>
                  <a href="https://github.com/delriodevelops" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="GitHub">
                    <Github size={20} />
                  </a>
                  <a href="https://www.youtube.com/@iamdelrio" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="YouTube">
                    <Youtube size={20} />
                  </a>
                </div>

                <div style={{ marginTop: 'var(--space-2xl)' }}>
                  <a href="/cv/en" className="btn btn-primary">
                    <Download size={18} />
                    Download CV
                  </a>
                </div>
              ...
              <form className="contact-form" style={{ opacity: 0, transform: 'translateX(60px)' }} onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="form-group">
                  ...
                  <textarea id="message" className="form-input form-textarea" placeholder="Tell me about your project..." required />
                </div>
          ...
          <div className="container">
            <div className="footer-content">
              <p className="footer-text">
                © {new Date().getFullYear()} Christian Del Río. Built with passion.
              </p>
              <div className="footer-links">
                <Link href="/blog" className="footer-link">Blog</Link>
                <Link href="/products" className="footer-link">Products</Link>
                <Link href="/blog/admin" className="footer-link">Admin</Link>
              </div>
            </div>
          </div>
        </footer>
